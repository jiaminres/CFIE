...
from cfie_training.profiles.qwen35_122b_a10b import (
    QWEN35_122B_A10B_PROFILE,
    build_qwen35_122b_a10b_config,
)
...
def build_profile_config(profile_name: str) -> TrainingProjectConfig:
    ...
    # ------------------------------- 根据训练档位名称分发 122B-A10B 配置 -------------------------------
    # 当训练档位名称为 Qwen3.5-122B-A10B 专用档位时，构造并返回对应的专用训练配置。
    if profile_name == QWEN35_122B_A10B_PROFILE:
        # 返回 Qwen3.5-122B-A10B 档位的训练项目配置对象。
        return build_qwen35_122b_a10b_config()
