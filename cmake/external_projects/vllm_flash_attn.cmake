...
if(NOT VLLM_FLASH_ATTN_SRC_DIR AND EXISTS "${CMAKE_SOURCE_DIR}/third_party/vllm-flash-attn")
  set(VLLM_FLASH_ATTN_SRC_DIR "${CMAKE_SOURCE_DIR}/third_party/vllm-flash-attn")
endif()
...
install(CODE "set(CMAKE_INSTALL_PREFIX \"\${CMAKE_INSTALL_PREFIX}/cfie/\")" ALL_COMPONENTS)
...
foreach(_FA_COMPONENT _vllm_fa2_C _vllm_fa3_C)
  ...
  install(CODE "file(MAKE_DIRECTORY \"\${CMAKE_INSTALL_PREFIX}/cfie/vllm_flash_attn\")"
  ...
  install(
    ...
    DESTINATION cfie/vllm_flash_attn
    COMPONENT ${_FA_COMPONENT}
...
# with cfie.vllm_flash_attn.cute to match our package structure.
install(CODE "
  ...
  foreach(SRC_FILE \${CUTE_PY_FILES})
    ...
    set(DST_FILE \"\${CMAKE_INSTALL_PREFIX}/cfie/vllm_flash_attn/cute/\${REL_PATH}\")
    get_filename_component(DST_DIR \${DST_FILE} DIRECTORY)
    file(MAKE_DIRECTORY \${DST_DIR})
    file(READ \${SRC_FILE} FILE_CONTENTS)
    string(REPLACE \"flash_attn.cute\" \"cfie.vllm_flash_attn.cute\" FILE_CONTENTS \"\${FILE_CONTENTS}\")
