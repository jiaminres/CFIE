...
from cfie.transformers_utils import processors
from cfie.transformers_utils.gguf_utils import is_gguf
from cfie.transformers_utils.repo_utils import get_hf_file_to_dict
from cfie.transformers_utils.utils import convert_model_repo_to_path
...
def _transformers_v4_compatibility_init() -> Any:
    ...
    if hasattr(ProcessorMixin, "optional_attributes"):
        return
    # Transformers v5
    if hasattr(ProcessorMixin.__init__, "_cfie_patched"):
        return
    ...
    if not hasattr(ProcessorMixin, "_mock_name"):
        __init__._cfie_patched = True  # type: ignore[attr-defined]
