...
from cfie.v1.metrics.perf import PerfStats
from cfie.v1.spec_decode.metrics import SpecDecodingStats

if TYPE_CHECKING:
    from cfie.v1.engine import EngineCoreEvent, EngineCoreOutput, FinishReason
...
class IterationStats:
    ...
    def update_from_events(
        ...
        from cfie.v1.engine import EngineCoreEventType
