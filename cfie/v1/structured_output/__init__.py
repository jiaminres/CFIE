...
class StructuredOutputManager:
    ...
    def __init__(self, cfie_config: CfieConfig):
        ...
        self._use_async_grammar_compilation = (
            cfie_config.parallel_config.distributed_executor_backend
            != "external_launcher"
        )
        ...
        max_batch_size = self.cfie_config.scheduler_config.max_num_seqs
        ...
        if not self.cfie_config.model_config.skip_tokenizer_init:
            ...
            reasoning_parser_plugin = (
                self.cfie_config.structured_outputs_config.reasoning_parser_plugin
            )
            if reasoning_parser_plugin and len(reasoning_parser_plugin) > 3:
                ReasoningParserManager.import_reasoning_parser(reasoning_parser_plugin)

            reasoning_parser = (
                self.cfie_config.structured_outputs_config.reasoning_parser
            )
            if reasoning_parser:
        ...
        self.enable_in_reasoning = (
            self.cfie_config.structured_outputs_config.enable_in_reasoning
        )
    ...
    def grammar_init(self, request: "Request") -> None:
        ...
        if self.backend is None:
            ...
            if backend == "xgrammar":
                ...
                from cfie.v1.structured_output.backend_outlines import OutlinesBackend
                ...
                from cfie.v1.structured_output.backend_lm_format_enforcer import (  # noqa: E501
    ...
    def grammar_bitmask(
        ...
        if self.cfie_config.speculative_config is not None:
            max_num_spec_tokens = (
                self.cfie_config.speculative_config.num_speculative_tokens
            )
