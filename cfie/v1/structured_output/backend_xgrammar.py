...
from cfie.v1.structured_output.utils import (
    choice_as_grammar,
...
class XgrammarBackend(StructuredOutputBackend):
    def __post_init__(self):
        self.disable_any_whitespace = (
            self.cfie_config.structured_outputs_config.disable_any_whitespace
        )
        ...
        self.compiler = xgr.GrammarCompiler(
            ...
            max_threads=8,
            cache_enabled=True,
            cache_limit_bytes=cfie.envs.VLLM_XGRAMMAR_CACHE_MB * 1024 * 1024,
        )
