...
from cfie.sampling_params import RequestOutputKind
...
from cfie.v1.engine import EngineCoreOutput, EngineCoreRequest, FinishReason
from cfie.v1.engine.detokenizer import IncrementalDetokenizer
from cfie.v1.engine.logprobs import LogprobsProcessor
    ...
    def process_outputs(
        ...
        for engine_core_output in engine_core_outputs:
            ...
            if request_output := req_state.make_request_output(
                ...
                kv_transfer_params,
                routed_experts,
                engine_core_output.router_logits,
            ):
