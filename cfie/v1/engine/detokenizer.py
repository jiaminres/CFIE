...
from cfie.tokenizers.detokenizer_utils import (
...
class BaseIncrementalDetokenizer(IncrementalDetokenizer, ABC):
    ...
    def update(self, new_token_ids: list[int], stop_terminated: bool) -> str | None:
        ...
        for new_token_id in new_token_ids:
            ...
            # Support min_tokens, see https://github.com/cfie-project/cfie/pull/22014
...
class FastIncrementalDetokenizer(BaseIncrementalDetokenizer):
    ...
    def _protected_step(self, next_token_id: int) -> str | None:
        try:
            ...
            # See https://github.com/cfie-project/cfie/issues/21951.
            ...
            # See https://github.com/cfie-project/cfie/issues/17448.
            logger.warning(
