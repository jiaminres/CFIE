...
from cfie.inputs.parse import split_enc_dec_inputs
from cfie.inputs.preprocess import InputPreprocessor
...
from cfie.multimodal.utils import argsort_mm_positions
from cfie.platforms import current_platform
from cfie.pooling_params import PoolingParams
from cfie.renderers import BaseRenderer, renderer_from_config
from cfie.sampling_params import SamplingParams
from cfie.tasks import GENERATION_TASKS, POOLING_TASKS, SupportedTask
from cfie.tokenizers import TokenizerLike
from cfie.utils import length_from_prompt_token_ids_or_embeds, random_uuid
from cfie.utils.jsontree import json_iter_leaves
from cfie.v1.engine import EngineCoreRequest
...
class InputProcessor:
    def __init__(
        ...
        *,
        ...
        self.model_config = model_config = cfie_config.model_config
        ...
        self.structured_outputs_config = cfie_config.structured_outputs_config
        self.observability_config = cfie_config.observability_config

        self.generation_config_fields = model_config.try_get_generation_config()

        self.renderer = renderer or renderer_from_config(cfie_config)
        ...
        if self.supports_mm_inputs:
            mm_budget = MultiModalBudget(cfie_config, mm_registry)
    ...
    def _validate_model_input(
        ...
        if prompt_ids and tokenizer is not None:
            ...
            # and https://github.com/cfie-project/cfie/pull/22471#discussion_r2312251421 # noqa: E501
