...
from cfie.config import SpeculativeConfig
...
class SpecDecodingProm:
    ...
    The acceptance rate can be calculated using a PromQL query:
      ...
      rate(cfie:spec_decode_num_accepted_tokens_total[$interval]) /
      rate(cfie:spec_decode_num_draft_tokens_total[$interval])
    ...
    can be calculated using:
      ...
      1 + (
      rate(cfie:spec_decode_num_accepted_tokens_total[$interval]) /
      rate(cfie:spec_decode_num_drafts[$interval]))

    A per-position acceptance rate vector can be computed using

      cfie:spec_decode_num_accepted_tokens_per_pos[$interval] /
      cfie:spec_decode_num_drafts[$interval]
    """
    ...
    def __init__(
        ...
        counter_drafts = self._counter_cls(
            name="cfie:spec_decode_num_drafts",
        ...
        counter_draft_tokens = self._counter_cls(
            name="cfie:spec_decode_num_draft_tokens",
        ...
        counter_accepted_tokens = self._counter_cls(
            name="cfie:spec_decode_num_accepted_tokens",
        ...
        base_counter = self._counter_cls(
            name="cfie:spec_decode_num_accepted_tokens_per_pos",
