...
from cfie.v1.attention.backend import AttentionBackend, AttentionType
from cfie.v1.attention.backends.registry import (
...
def get_attn_backend(
    ...
    return _cached_get_attn_backend(
        backend=cfie_config.attention_config.backend,
