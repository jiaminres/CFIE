...
def flash_attn_maxseqlen_wrapper(
    ...
    if is_rocm_aiter:
        ...
        from cfie.v1.attention.backends.fa_utils import flash_attn_varlen_func
...
def vit_flash_attn_wrapper(
    ...
    return torch.ops.cfie.flash_attn_maxseqlen_wrapper(
        q,
        k,
        v,
        batch_size,
...
def vit_triton_attn_wrapper(
    ...
    return torch.ops.cfie.triton_attn_wrapper(
        q,
        k,
        v,
        batch_size,
...
def vit_torch_sdpa_wrapper(
    ...
    return torch.ops.cfie.torch_sdpa_wrapper(
...
def vit_flashinfer_wrapper(
    ...
    return torch.ops.cfie.flashinfer_wrapper(
