...
if current_platform.is_cuda():
    try:
        import cfie._flashmla_C  # noqa: F401
...
if current_platform.is_cuda():
    try:
        import cfie._flashmla_extension_C  # noqa: F401
...
def _is_flashmla_available() -> tuple[bool, str | None]:
    if not _flashmla_C_AVAILABLE:
        return (
            False,
            "cfie._flashmla_C is not available, likely was not "
    ...
    if not _flashmla_extension_C_AVAILABLE:
        return (
            False,
            "cfie._flashmla_extension_C is not available, likely "
...
if _is_flashmla_available()[0]:
    from cfie.third_party.flashmla.flash_mla_interface import (  # noqa: F401
        FlashMLASchedMeta,
