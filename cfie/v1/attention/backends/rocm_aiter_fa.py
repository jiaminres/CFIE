...
class AiterFlashAttentionMetadataBuilder(
    ...
    def __init__(
        ...
        layers = get_layers_from_cfie_config(self.cfie_config, Attention)
    ...
    def build_for_cudagraph_capture(
        ...
        self.total_tokens = (
            ...
            * self.cfie_config.scheduler_config.max_num_partial_prefills
        )
    ...
    def build(
        ...
        if (
            ...
            and self.cfie_config.cache_config.cache_dtype.startswith("fp8")
        ):
            layers = get_layers_from_cfie_config(self.cfie_config, Attention)
            first_layer_name = [k for k in layers][0]
            kv_cache_shape = (
                self.cfie_config.compilation_config.static_forward_context[
                    first_layer_name
                ]
                .kv_cache[0]
                .shape
        ...
        if num_extends > 0:
            ...
            if self.aot_sliding_window is not None:
                ...
                swa_workspace = torch.empty(
                    ...
                    dtype=self.cfie_config.model_config.dtype,
                    device=self.device,
                )
...
class AiterFlashAttentionBackend(AttentionBackend):
    ...
    def supports_compute_capability(cls, capability: DeviceCapability) -> bool:
        from cfie.platforms.rocm import on_mi3xx
