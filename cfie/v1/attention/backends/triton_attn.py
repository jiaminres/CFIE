...
from cfie.v1.attention.ops.triton_unified_attention import unified_attention
...
class TritonAttentionMetadataBuilder(AttentionMetadataBuilder[TritonAttentionMetadata]):
    ...
    def __init__(
        ...
        self.num_heads_kv = model_config.get_num_kv_heads(cfie_config.parallel_config)
        ...
        if self.decode_cudagraph_enabled:
            capture_sizes = self.cfie_config.compilation_config.cudagraph_capture_sizes
