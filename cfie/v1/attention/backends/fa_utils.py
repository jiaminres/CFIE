...
if current_platform.is_cuda():
    from cfie._custom_ops import reshape_and_cache_flash
    ...
    from cfie._xpu_ops import xpu_ops
...
def get_flash_attn_version(
    ...
    if current_platform.is_rocm():
        # ROCm doesn't use cfie_flash_attn; return None to skip fa_version arg
        return None
    try:
        ...
        if (
            ...
            and cfie_config.attention_config.flash_attn_version is not None
        ):
            fa_version = cfie_config.attention_config.flash_attn_version
        ...
        if cfie_is_batch_invariant() and fa_version == 4:
            logger.warning_once(
...
def is_flash_attn_varlen_func_available() -> bool:
    ...
    - CUDA: cfie.cfie_flash_attn.flash_attn_varlen_func
