...
from cfie.distributed.parallel_state import get_dcp_group
...
from cfie.utils.torch_utils import is_strictly_contiguous
...
from cfie.v1.kv_cache_interface import AttentionSpec, UniformTypeKVCacheSpecs
...
class FlashInferMetadataBuilder(AttentionMetadataBuilder[FlashInferMetadata]):
    ...
    def __init__(
        ...
        super().__init__(kv_cache_spec, layer_names, cfie_config, device)
        self.cache_config = cfie_config.cache_config
        self.model_config = cfie_config.model_config
        self.attention_config = cfie_config.attention_config
        ...
        max_num_reqs = cfie_config.scheduler_config.max_num_seqs
        ...
        try:
            ...
            self.dcp_kv_cache_interleave_size = (
                cfie_config.parallel_config.dcp_kv_cache_interleave_size
            )
        ...
        self.dcp_a2a = (
            self.use_dcp and cfie_config.parallel_config.dcp_comm_backend == "a2a"
        )
        ...
        if (
            can_use_trtllm
            and not cfie_config.attention_config.disable_flashinfer_q_quantization
        ):
        ...
        self.global_hyperparameters = infer_global_hyperparameters(
            get_per_layer_parameters(cfie_config, layer_names, FlashInferImpl)
        )
    ...
    def get_cudagraph_support(
        ...
        num_qo_heads = cfie_config.model_config.get_num_attention_heads(
    ...
    def use_cascade_attention(self, *args, **kwargs) -> bool:
        if self.kv_cache_spec.dtype != self.cfie_config.model_config.dtype:
