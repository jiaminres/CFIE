...
from cfie.v1.kv_cache_interface import AttentionSpec, MambaSpec
...
class BaseMambaAttentionMetadataBuilder(AttentionMetadataBuilder[M], abc.ABC):
    ...
    def __init__(
        ...
        self.num_spec_tokens: int = cfie_config.num_speculative_tokens
        ...
        if self.cfie_config.cache_config.mamba_cache_mode == "all":
            max_num_blocks = cdiv(
        ...
        *,
        ...
        if self.cfie_config.cache_config.mamba_cache_mode == "all":
            ...
            state_indices_tensor = mamba_get_block_table_tensor(
                ...
                self.kv_cache_spec,
                self.cfie_config.cache_config.mamba_cache_mode,
            )
