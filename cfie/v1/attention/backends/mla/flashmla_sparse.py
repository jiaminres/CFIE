...
from cfie.v1.attention.backends.mla.sparse_utils import (
...
from cfie.v1.attention.ops.flashmla import (
    FlashMLASchedMeta,
...
from cfie.v1.worker.workspace import current_workspace_manager

if TYPE_CHECKING:
    from cfie.model_executor.models.deepseek_v2 import Indexer
...
class FlashMLASparseMetadataBuilder(AttentionMetadataBuilder[FlashMLASparseMetadata]):
    ...
    def __init__(
        ...
        self.topk_tokens = cfie_config.model_config.hf_config.index_topk
        self.use_fp8_kv_cache = cache_config.cache_dtype == "fp8_ds_mla"
        max_num_seqs = cfie_config.scheduler_config.max_num_seqs
    ...
    def _build_fp8_separate_prefill_decode(
        ...
        if num_prefills > 0:
            ...
            max_prefill_buffer_size = get_prefill_workspace_size(
                self.cfie_config.model_config.max_model_len
            )
...
class FlashMLASparseImpl(SparseMLAAttentionImpl[FlashMLASparseMetadata]):
    ...
    def __init__(
        ...
        **mla_args,
        ...
        max_tokens = cfie_config.scheduler_config.max_num_batched_tokens
        ...
        if kv_cache_dtype == "fp8_ds_mla":
            ...
            assert cfie_config is not None and cfie_config.model_config is not None
