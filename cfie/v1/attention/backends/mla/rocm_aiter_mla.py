...
class AiterMLAMetadataBuilder(MLACommonMetadataBuilder[AiterMLAMetadata]):
    ...
    def __init__(
        ...
        super().__init__(
            kv_cache_spec, layer_names, cfie_config, device, AiterMLAMetadata
        )

        self.compilation_config = cfie_config.compilation_config
        self.decode_attn_out_dtype = cfie_config.model_config.dtype
        # kernel block size is always 1.
        max_num_pages_per_req = cfie_config.model_config.max_model_len
