...
from cfie.v1.kv_cache_interface import AttentionSpec, CrossAttentionSpec
...
class CPUAttentionMetadataBuilder(AttentionMetadataBuilder[CPUAttentionMetadata]):
    def __init__(
        ...
        self.num_kv_heads = cfie_config.model_config.get_num_kv_heads(parallel_config)
        self.num_heads = cfie_config.model_config.get_num_attention_heads(
            parallel_config
        )
