...
def _get_sliding_window_configs(
    ...
    layers = get_layers_from_cfie_config(cfie_config, Attention)
...
class FlashAttentionMetadataBuilder(AttentionMetadataBuilder[FlashAttentionMetadata]):
    ...
    def __init__(
        ...
        if self.use_full_cuda_graph and self.aot_schedule:
            ...
            max_batch_size = max(
                cfie_config.scheduler_config.max_num_seqs,
    ...
    def build(
        ...
        if self.aot_sliding_window is None:
            ...
            # in __init__.
            if aot_schedule:
                sliding_window_configs = _get_sliding_window_configs(self.cfie_config)
