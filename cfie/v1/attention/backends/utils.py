...
if TYPE_CHECKING:
    ...
    from cfie.v1.worker.gpu_input_batch import InputBatch

import cfie.envs as envs
from cfie.distributed.kv_transfer.kv_connector.utils import (
...
def get_per_layer_parameters(
    cfie_config: CfieConfig, layer_names: list[str], cls_: type["AttentionImpl"]
