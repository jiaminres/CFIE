...
if TYPE_CHECKING:
    from cfie.v1.attention.backend import AttentionBackend
...
class AttentionBackendEnum(Enum, metaclass=_AttentionBackendEnumMeta):
    ...
    FLASH_ATTN = "cfie.v1.attention.backends.flash_attn.FlashAttentionBackend"
    FLASH_ATTN_DIFFKV = (
        "cfie.v1.attention.backends.flash_attn_diffkv.FlashAttentionDiffKVBackend"
    )
    TRITON_ATTN = "cfie.v1.attention.backends.triton_attn.TritonAttentionBackend"
    ROCM_ATTN = "cfie.v1.attention.backends.rocm_attn.RocmAttentionBackend"
    ROCM_AITER_MLA = "cfie.v1.attention.backends.mla.rocm_aiter_mla.AiterMLABackend"
    ROCM_AITER_TRITON_MLA = (
        "cfie.v1.attention.backends.mla.aiter_triton_mla.AiterTritonMLABackend"
    )
    ROCM_AITER_FA = (
        "cfie.v1.attention.backends.rocm_aiter_fa.AiterFlashAttentionBackend"
    )
    ROCM_AITER_MLA_SPARSE = (
        "cfie.v1.attention.backends.mla.rocm_aiter_mla_sparse.ROCMAiterMLASparseBackend"
    )
    XPU_MLA_SPARSE = "cfie.v1.attention.backends.mla.xpu_mla_sparse.XPUMLASparseBackend"
    TORCH_SDPA = ""  # this tag is only used for ViT
    FLASHINFER = "cfie.v1.attention.backends.flashinfer.FlashInferBackend"
    FLASHINFER_MLA = (
        "cfie.v1.attention.backends.mla.flashinfer_mla.FlashInferMLABackend"
    )
    FLASHINFER_MLA_SPARSE = (
        "cfie.v1.attention.backends.mla.flashinfer_mla_sparse."
        "FlashInferMLASparseBackend"
    )
    TRITON_MLA = "cfie.v1.attention.backends.mla.triton_mla.TritonMLABackend"
    CUTLASS_MLA = "cfie.v1.attention.backends.mla.cutlass_mla.CutlassMLABackend"
    FLASHMLA = "cfie.v1.attention.backends.mla.flashmla.FlashMLABackend"
    FLASHMLA_SPARSE = (
        "cfie.v1.attention.backends.mla.flashmla_sparse.FlashMLASparseBackend"
    )
    FLASH_ATTN_MLA = "cfie.v1.attention.backends.mla.flashattn_mla.FlashAttnMLABackend"
    NO_ATTENTION = "cfie.v1.attention.backends.no_attention.NoAttentionBackend"
    FLEX_ATTENTION = "cfie.v1.attention.backends.flex_attention.FlexAttentionBackend"
    TREE_ATTN = "cfie.v1.attention.backends.tree_attn.TreeAttentionBackend"
    ROCM_AITER_UNIFIED_ATTN = (
        "cfie.v1.attention.backends.rocm_aiter_unified_attn."
        "RocmAiterUnifiedAttentionBackend"
    )
    CPU_ATTN = "cfie.v1.attention.backends.cpu_attn.CPUAttentionBackend"
...
class MambaAttentionBackendEnum(Enum, metaclass=_AttentionBackendEnumMeta):
    ...
    MAMBA1 = "cfie.v1.attention.backends.mamba1_attn.Mamba1AttentionBackend"
    MAMBA2 = "cfie.v1.attention.backends.mamba2_attn.Mamba2AttentionBackend"
    SHORT_CONV = "cfie.v1.attention.backends.short_conv_attn.ShortConvAttentionBackend"
    LINEAR = "cfie.v1.attention.backends.linear_attn.LinearAttentionBackend"
    GDN_ATTN = "cfie.v1.attention.backends.gdn_attn.GDNAttentionBackend"
    # Placeholder for third-party/custom backends - must be registered before use
    # set to None to avoid alias with other backend, whose value is an empty string
    CUSTOM = None
