...
if TYPE_CHECKING:
    ...
    from cfie.v1.attention.backends.utils import KVCacheLayoutType
...
class AttentionMetadataBuilder(ABC, Generic[M]):
    ...
    def _init_reorder_batch_threshold(
        ...
        if self.reorder_batch_threshold is not None and supports_spec_as_decode:
            ...
            speculative_config = self.cfie_config.speculative_config
            if (
        ...
        if (
            self.cfie_config.parallel_config.decode_context_parallel_size > 1
...
class AttentionImplBase(ABC, Generic[T]):
    ...
    # https://github.com/cfie-project/cfie/issues/25584
    ...
    def __new__(cls, *args, **kwargs):
        ...
        try:
            ...
            self.dcp_rank = 0
        try:
            from cfie.distributed.parallel_state import get_pcp_group
...
class AttentionImpl(AttentionImplBase[T], Generic[T]):
    ...
    def do_rope_and_kv_cache_update(
        ...
        by torch.ops.cfie.fused_rope_and_unified_kv_cache_update
