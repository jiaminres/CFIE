...
from cfie.v1.worker.gpu.input_batch import InputBatch, InputBuffers
from cfie.v1.worker.gpu.model_states.interface import ModelState
from cfie.v1.worker.gpu.sample.gumbel import gumbel_sample
from cfie.v1.worker.gpu.spec_decode.eagle.cudagraph import EagleCudaGraphManager
from cfie.v1.worker.gpu.spec_decode.eagle.utils import load_eagle_model
...
class EagleSpeculator:
    def __init__(self, cfie_config: CfieConfig, device: torch.device):
        ...
        # DP configuration
        self.dp_size = cfie_config.parallel_config.data_parallel_size
        ...
        cudagraph_mode = cfie_config.compilation_config.cudagraph_mode
        ...
        self.cudagraph_manager = EagleCudaGraphManager(
            cfie_config, device, cudagraph_mode, self.draft_tokens
        )

    def load_model(self, target_model: nn.Module) -> None:
        self.model = load_eagle_model(target_model, self.cfie_config)
