...
from cfie.distributed.parallel_state import graph_capture, is_global_first_rank
from cfie.forward_context import BatchDescriptor, set_forward_context
from cfie.logger import init_logger
from cfie.model_executor.offloader.base import get_offloader
from cfie.platforms import current_platform
from cfie.v1.kv_cache_interface import KVCacheConfig
from cfie.v1.worker.gpu.attn_utils import build_slot_mappings_by_layer
...
class CudaGraphManager:
    def __init__(
        ...
        self.device = device
        self.max_num_reqs = cfie_config.scheduler_config.max_num_seqs
...
class ModelCudaGraphManager(CudaGraphManager):
    ...
    def __init__(
        ...
        super().__init__(cfie_config, device, cudagraph_mode, decode_query_len)
