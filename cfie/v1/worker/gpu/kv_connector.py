...
class ActiveKVConnector(KVConnector):
    def __init__(
        self, cfie_config: CfieConfig, kv_caches_dict: dict[str, torch.Tensor]
    ):
...
def get_kv_connector(
    cfie_config: CfieConfig, kv_caches_dict: dict[str, torch.Tensor]
) -> KVConnector:
    if not has_kv_transfer_group():
        # No-op connector.
        return NO_OP_KV_CONNECTOR

    return ActiveKVConnector(cfie_config, kv_caches_dict)
