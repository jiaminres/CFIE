...
from cfie.forward_context import get_forward_context, set_forward_context
...
class KVConnectorModelRunnerMixin:
    ...
    def kv_connector_no_forward(
        scheduler_output: "SchedulerOutput", cfie_config: CfieConfig
    ) -> ModelRunnerOutput:
        # KV send/recv even if no work to do.
        with (
            set_forward_context(None, cfie_config),
