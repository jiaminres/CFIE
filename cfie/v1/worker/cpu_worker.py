...
from cfie.platforms.cpu import CpuPlatform, LogicalCPUInfo
from cfie.profiler.wrapper import TorchProfilerWrapper
from cfie.utils.torch_utils import set_random_seed
from cfie.v1.worker.cpu_model_runner import CPUModelRunner
...
class CPUWorker(Worker):
    ...
    def init_device(self):
        ...
        def check_preloaded_libs(name: str):
            ...
            if name not in ld_preload_list:
                raise RuntimeError(
                    ...
                    "https://docs.cfie.ai/en/latest/getting_started/installation/cpu/ "
        ...
        self.model_runner: CPUModelRunner = CPUModelRunner(
            self.cfie_config, torch.device("cpu")
        )
