...
from cfie.lora.worker_manager import LRUCacheWorkerLoRAManager
from cfie.model_executor.models import supports_lora
from cfie.v1.worker.gpu_input_batch import InputBatch as GPUInputBatch
from cfie.v1.worker.tpu_input_batch import InputBatch as TPUInputBatch
...
class LoRAModelRunnerMixin:
    def load_lora_model(
        ...
        return self.lora_manager.create_lora_manager(model, cfie_config)
