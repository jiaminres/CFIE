...
from cfie.utils.system_utils import update_environment_variables
from cfie.v1.kv_cache_interface import KVCacheSpec

if TYPE_CHECKING:
    from cfie.v1.core.sched.output import GrammarOutput, SchedulerOutput
    from cfie.v1.outputs import AsyncModelRunnerOutput, ModelRunnerOutput
else:
...
class WorkerBase:
    ...
    def __init__(
        ...
        Args:
            cfie_config: Complete vLLM configuration
        ...
        self.kv_transfer_config = cfie_config.kv_transfer_config
...
class WorkerWrapperBase:
    ...
    def __init__(
        ...
        """
        Initialize the worker wrapper with the given cfie_config and rpc_rank.
    ...
    def init_worker(self, all_kwargs: list[dict[str, Any]]) -> None:
        ...
        cfie_config: CfieConfig | None = kwargs.get("cfie_config")
        assert cfie_config is not None, (
            "cfie_config is required to initialize the worker"
        )
        self.cfie_config = cfie_config

        cfie_config.enable_trace_function_call_for_thread()
    ...
    def initialize_from_config(self, kv_cache_configs: list[Any]) -> None:
        ...
        assert self.cfie_config is not None
        with set_current_cfie_config(self.cfie_config):
