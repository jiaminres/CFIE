...
from cfie.v1.outputs import AsyncModelRunnerOutput
...
try:
    ...
    class RayWorkerWrapper(WorkerWrapperBase):
        """Ray wrapper for cfie.worker.Worker, allowing Worker to be
        ...
        def execute_method(self, method: str | bytes, *args, **kwargs):
            try:
                ...
                # see https://github.com/cfie-project/cfie/issues/3455
                msg = (
        ...
        def get_node_and_gpu_ids(self) -> tuple[str, list[int]]:
            ...
            device_key = cfie.platforms.current_platform.ray_device_key
            if not device_key:
                raise RuntimeError(
                    "current platform %s does not support ray.",
                    cfie.platforms.current_platform.device_name,
                )
