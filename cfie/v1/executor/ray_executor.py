...
from cfie.v1.executor.ray_utils import (
    FutureWrapper,
    RayWorkerWrapper,
...
class RayDistributedExecutor(Executor):
    ...
    def _init_executor(self) -> None:
        ...
        # KV connector setup
        self.has_connector = self.cfie_config.kv_transfer_config is not None

        self.uses_sampler = self.cfie_config.model_config.runner_type != "pooling" and (
            self.cfie_config.ec_transfer_config is None
            or self.cfie_config.ec_transfer_config.is_ec_consumer
        )
    ...
    def _init_workers_ray(self, placement_group: "PlacementGroup", **ray_remote_kwargs):
        ...
        # The way ray actors are setup in cfie is that the visible devices are
        ...
        def sort_by_driver_then_worker_ip(item: RayWorkerMetaData):
            ...
            1. If the worker is on the same node as the driver (cfie engine),
        ...
        for i, (node_id, gpu_ids) in enumerate(worker_node_and_gpu_ids):
            ...
            # see https://github.com/cfie-project/cfie/issues/5590
        ...
        def _update_block_size(worker):
            current_platform.update_block_size_for_backend(worker.cfie_config)
    ...
    def _compiled_ray_dag(self, enable_asyncio: bool):
        ...
        # intermediate tensor communications, in the case of cfie.
        ...
        if envs.VLLM_USE_RAY_WRAPPED_PP_COMM:
            ...
            from cfie.distributed.device_communicators.ray_communicator import (
                RayPPCommunicator,
            )
