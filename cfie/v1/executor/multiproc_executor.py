...
from cfie.distributed import destroy_distributed_environment, destroy_model_parallel
from cfie.distributed.device_communicators.shm_broadcast import Handle, MessageQueue
...
from cfie.utils.system_utils import (
    _maybe_force_spawn,
    decorate_logs,
    get_mp_context,
    set_process_title,
...
from cfie.v1.executor.abstract import Executor, FailureCallback
...
class MultiprocExecutor(Executor):
    ...
    def __init__(self, cfie_config: CfieConfig, monitor_workers: bool = True):
        self.monitor_workers = monitor_workers
        super().__init__(cfie_config)
...
class WorkerProc:
    ...
    def _init_message_queues(
        self, input_shm_handle: Handle, cfie_config: CfieConfig
    ) -> None:
        if cfie_config.parallel_config.nnodes_within_dp == 1:
    ...
    def __init__(
        ...
        all_kwargs: list[dict] = [
            {} for _ in range(cfie_config.parallel_config.world_size)
        ]
        ...
        self.setup_proc_title_and_log_prefix(
            enable_ep=cfie_config.parallel_config.enable_expert_parallel
        )
        ...
        current_platform.update_block_size_for_backend(cfie_config)
        ...
        self._init_message_queues(input_shm_handle, cfie_config)
    ...
    def worker_main(*args, **kwargs):
        ...
        try:
            ...
            maybe_init_worker_tracer(
                instrumenting_module_name="cfie.worker",
                process_kind="worker",
