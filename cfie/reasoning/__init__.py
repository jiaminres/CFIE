...
from cfie.reasoning.abs_reasoning_parsers import ReasoningParser, ReasoningParserManager
...
Example:
    ReasoningParserManager.register_lazy_module(
        name="qwen3",
        module_path="cfie.reasoning.qwen3_reasoning_parser",
...
def register_lazy_reasoning_parsers():
    for name, (file_name, class_name) in _REASONING_PARSERS_TO_REGISTER.items():
        module_path = f"cfie.reasoning.{file_name}"
