...
from cfie.inputs.data import build_enc_dec_inputs
...
from cfie.renderers.inputs import (
    DecoderDictPrompt,
...
from cfie.renderers.inputs.preprocess import parse_dec_only_prompt, parse_enc_dec_prompt
...
class InputPreprocessor:
    ...
    def _prompt_to_llm_inputs(
        ...
        * [`SingletonInputs`][cfie.inputs.data.SingletonInputs] instance
        """
    ...
    def _process_encoder_decoder_prompt(
        ...
        [`EncoderDecoderInputs`][cfie.inputs.data.EncoderDecoderInputs]
        instance.
    ...
    def _process_decoder_only_prompt(
        ...
        [`DecoderOnlyInputs`][cfie.inputs.data.DecoderOnlyInputs] instance.
