...
from cfie.multimodal.registry import MultiModalRegistry
from cfie.utils.torch_utils import set_default_torch_num_threads
from cfie.v1.core.encoder_cache_manager import compute_mm_encoder_budget
...
class MultiModalBudget:
    ...
    def __init__(
        ...
        self.scheduler_config = scheduler_config = cfie_config.scheduler_config

        self.max_model_len = model_config.max_model_len
        self.max_num_reqs = scheduler_config.max_num_seqs

        with set_default_torch_num_threads():  # Avoid hang during startup
            cache = mm_registry.processor_only_cache_from_config(cfie_config)
