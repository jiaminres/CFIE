...
from cfie.multimodal.inputs import MultiModalDataDict
...
from cfie.renderers import TokenizeParams
from cfie.tokenizers import TokenizerLike
from cfie.transformers_utils.processor import cached_processor_from_config
from cfie.utils.func_utils import get_allowed_kwarg_only_overrides
from cfie.utils.jsontree import JSONTree, json_map_leaves
...
class InputProcessingContext:
    """输入处理上下文：封装模型配置与 tokenizer，供多模态处理链复用。"""
...
class BaseProcessingInfo:
    """数据处理信息抽象：提供 processor 构造与输入处理所需的模型相关信息。"""
    ...
    def get_data_parser(self) -> MultiModalDataParser:
        ...
        [`_get_hf_mm_data`][cfie.multimodal.processing.BaseMultiModalProcessor._get_hf_mm_data].

        You can support additional modalities by creating a subclass
        of [`MultiModalDataParser`][cfie.multimodal.parse.MultiModalDataParser]
    ...
    def parse_mm_data(
        ...
        *,
        ...
        """
        Normalize
        [`MultiModalDataDict`][cfie.multimodal.inputs.MultiModalDataDict]
        to [`MultiModalDataItems`][cfie.multimodal.parse.MultiModalDataItems]
        before passing them to
        [`_get_hf_mm_data`][cfie.multimodal.processing.BaseMultiModalProcessor._get_hf_mm_data].
        """
