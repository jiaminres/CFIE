...
class MultiModalDataItems(UserDict[str, ModalityDataItems[Any, Any]]):
    """
    As [`MultiModalDataDict`][cfie.multimodal.inputs.MultiModalDataDict], but
...
class MultiModalDataParser:
    """
    Parses [`MultiModalDataDict`][cfie.multimodal.inputs.MultiModalDataDict]
    into [`MultiModalDataItems`][cfie.multimodal.parse.MultiModalDataItems].
...
"""
As [`MultiModalUUIDDict`][cfie.multimodal.inputs.MultiModalUUIDDict], but
normalized such that each entry corresponds to a list.
"""
