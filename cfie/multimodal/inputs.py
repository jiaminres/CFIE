...
from cfie.utils.jsontree import json_map_leaves
...
if TYPE_CHECKING:
    ...
    from cfie.inputs.data import _InputOptions
else:
...
[`MultiModalDataBuiltins`][cfie.multimodal.inputs.MultiModalDataBuiltins].
"""
...
def nested_tensors_equal(a: NestedTensors, b: NestedTensors) -> bool:
    ...
    [`NestedTensors`][cfie.multimodal.inputs.NestedTensors] objects.
    """
...
[`MultiModalKwargsItems.get_data`][cfie.multimodal.inputs.MultiModalKwargsItems.get_data].
"""
...
def batched_tensors_equal(a: BatchedTensorInputs, b: BatchedTensorInputs) -> bool:
    """
    Equality check between
    [`BatchedTensorInputs`][cfie.multimodal.inputs.BatchedTensorInputs] objects.
    """
...
class MultiModalFieldElem:
    ...
    [`MultiModalKwargsItem`][cfie.multimodal.inputs.MultiModalKwargsItem].
    """
...
class BaseMultiModalField(ABC):
    ...
    [`MultiModalKwargsItems`][cfie.multimodal.inputs.MultiModalKwargsItems],
    and vice versa.
    """
    ...
    [`group_and_batch_mm_items`][cfie.multimodal.utils.group_and_batch_mm_items]
    ...
    def build_elems(
        ...
        """
        Construct
        [`MultiModalFieldElem`][cfie.multimodal.inputs.MultiModalFieldElem]
        instances to represent the provided data.

        This is the inverse of
        [`reduce_data`][cfie.multimodal.inputs.BaseMultiModalField.reduce_data].
        """
    ...
    def reduce_data(
        ...
        *,
        ...
        This is the inverse of
        [`build_elems`][cfie.multimodal.inputs.BaseMultiModalField.build_elems].
        """
...
class MultiModalBatchedField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.batched`][cfie.multimodal.inputs.MultiModalFieldConfig.batched]
    """
...
class MultiModalFlatField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.flat`][cfie.multimodal.inputs.MultiModalFieldConfig.flat]
        [`MultiModalFieldConfig.flat_from_sizes`][cfie.multimodal.inputs.MultiModalFieldConfig.flat_from_sizes]
    """
    ...
    def _reduce_data(
        ...
        *,
        ...
        if len(batch) > 0 and is_list_of(batch, torch.Tensor, check="all"):
            ...
            # See: https://github.com/cfie-project/cfie/issues/31658
...
class MultiModalSharedField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.shared`][cfie.multimodal.inputs.MultiModalFieldConfig.shared]
    """
...
class MultiModalKwargsItem(UserDict[str, MultiModalFieldElem]):
    ...
    [`MultiModalDataItems`][cfie.multimodal.parse.MultiModalDataItems].
    """
...
class MultiModalKwargsItems(UserDict[str, Sequence[_I]]):
    ...
    [`BaseMultiModalField`][cfie.multimodal.inputs.BaseMultiModalField]
...
class MultiModalInputs(_InputOptions):
    ...
    [`BaseMultiModalProcessor`][cfie.multimodal.processing.BaseMultiModalProcessor],
...
class MultiModalEncDecInputs(MultiModalInputs):
    """
    Represents the outputs of
    [`EncDecMultiModalProcessor`][cfie.multimodal.processing.EncDecMultiModalProcessor]
    ready to be passed to vLLM internals.
