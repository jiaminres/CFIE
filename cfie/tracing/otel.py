...
from cfie.tracing.utils import TRACE_HEADERS, LoadingSpanAttributes
...
def init_otel_tracer(
    ...
    resource_attrs = {}
    resource_attrs["cfie.instrumenting_module_name"] = instrumenting_module_name
    resource_attrs["cfie.process_id"] = str(os.getpid())
    if extra_attributes:
...
def init_otel_worker_tracer(
    ...
    extra_attrs = {
        "cfie.process_kind": process_kind,
        "cfie.process_name": process_name,
    }
