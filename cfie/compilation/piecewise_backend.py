...
class PiecewiseBackend:
    def __init__(
        ...
        self.is_encoder_compilation = cfie_backend.is_encoder
    ...
    def compile_all_ranges(self) -> None:
        ...
        for range_entry in self.range_entries.values():
            ...
            range_entry.runnable = self.cfie_backend.compiler_manager.compile(
                self.graph,
                args_list,
                self.cfie_backend.inductor_config,
    ...
    def _log_compile_start(self, compile_range: Range):
        ...
        trace_structured(
            "artifact",
            metadata_fn=lambda: {
                "name": "cfie_piecewise_compile_start",
                "encoding": "json",
            },
