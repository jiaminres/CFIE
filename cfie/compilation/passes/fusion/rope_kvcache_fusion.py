...
from cfie.config import CfieConfig, get_layers_from_cfie_config
from cfie.config.utils import Range
...
class RopeReshapeKVCachePattern:
    ...
    FUSED_OP = torch.ops.cfie.fused_rope_and_unified_kv_cache_update.default
    ...
    def register(self, pm_pass: PatternMatcherPass) -> None:
        def pattern(
            ...
            dummy = torch.ops.cfie.unified_kv_cache_update(k, v, self.layer_name)
            return dummy, q, k, v
...
class RopeKVCacheFusionPass(CfiePatternMatcherPass):
    """
    ...
    def __init__(self, config: CfieConfig) -> None:
        ...
        attn_layers = get_layers_from_cfie_config(config, Attention)
    ...
    def uuid(self) -> str:
        return CfieInductorPass.hash_source(self, RopeReshapeKVCachePattern)
