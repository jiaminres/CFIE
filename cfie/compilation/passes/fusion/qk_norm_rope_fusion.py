...
from cfie.model_executor.layers.rotary_embedding import RotaryEmbedding
...
class QKNormRoPEFusionPass(CfiePatternMatcherPass):
    ...
    def __init__(self, config: CfieConfig) -> None:
        ...
        attn_layers: dict[str, Attention] = get_layers_from_cfie_config(
            config, Attention
        )
    ...
    def uuid(self) -> str:
        return CfieInductorPass.hash_source(self, QkNormRopePattern)
