...
from cfie.distributed import get_tp_group, tensor_model_parallel_all_reduce
...
if flashinfer_comm is not None:
    ...
    def call_trtllm_fused_allreduce_norm(
        ...
        if workspace.backend == "trtllm":
            # in cfie we only support swizzled layout
...
class AllReduceFusionPass(CfiePatternMatcherPass):
