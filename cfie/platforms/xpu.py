...
import cfie_xpu_kernels._C  # noqa
import cfie_xpu_kernels._moe_C  # noqa
import cfie_xpu_kernels._xpu_C  # noqa

from cfie.logger import init_logger
from cfie.utils.torch_utils import supports_xpu_graph
...
class XPUPlatform(Platform):
    ...
    def get_attn_backend_cls(
        ...
        from cfie.v1.attention.backends.utils import set_kv_cache_layout
    ...
    def get_punica_wrapper(cls) -> str:
        ...
        if not xpu_use_triton_kernel:
            return "cfie.lora.punica_wrapper.punica_xpu.PunicaWrapperXPU"
        else:
    ...
    def check_and_update_config(cls, cfie_config: CfieConfig) -> None:
        ...
        # This allows custom workers (like cfie-omni workers) to be used on XPU
        if parallel_config.worker_cls == "auto":
            parallel_config.worker_cls = "cfie.v1.worker.xpu_worker.XPUWorker"
        if cfie_config.kv_transfer_config is not None:
            cfie_config.kv_transfer_config.enable_permute_local_kv = True
    ...
    def get_device_communicator_cls(cls) -> str:
        ...
        return "cfie.distributed.device_communicators.xpu_communicator.XpuCommunicator"  # noqa
