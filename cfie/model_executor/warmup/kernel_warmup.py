...
from cfie.model_executor.warmup.deep_gemm_warmup import deep_gemm_warmup
from cfie.platforms import current_platform
from cfie.utils.deep_gemm import is_deep_gemm_supported
from cfie.utils.flashinfer import has_flashinfer

if TYPE_CHECKING:
    from cfie.v1.worker.gpu_model_runner import GPUModelRunner
    from cfie.v1.worker.gpu_worker import Worker
...
def kernel_warmup(worker: "Worker"):
    ...
    enable_flashinfer_autotune = (
        worker.cfie_config.kernel_config.enable_flashinfer_autotune
    )
...
def flashinfer_autotune(runner: "GPUModelRunner") -> None:
    ...
    """
    import cfie.utils.flashinfer as fi_utils
