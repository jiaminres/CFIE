...
from cfie.config import CacheConfig, ModelConfig, get_current_cfie_config
...
from cfie.model_executor.custom_op import CustomOp, PluggableLayer
...
from cfie.model_executor.layers.mamba.ops.layernorm_gated import rms_norm_gated
from cfie.model_executor.layers.mamba.ops.mamba_ssm import selective_state_update
from cfie.model_executor.layers.mamba.ops.ssd_combined import (
...
from cfie.model_executor.parameter import BasevLLMParameter
...
from cfie.v1.attention.backends.mamba2_attn import Mamba2AttentionMetadata
...
class MambaMixer2(MambaBase, PluggableLayer):
    ...
    **selective** state spaces)
    ...
    def __init__(
        ...
        self.num_spec = cfie_config.num_speculative_tokens
