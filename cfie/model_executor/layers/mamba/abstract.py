...
from cfie.v1.attention.selector import get_mamba_attn_backend
from cfie.v1.kv_cache_interface import KVCacheSpec, MambaSpec
...
class MambaBase(AttentionLayerBase):
    ...
    def get_kv_cache_spec(self, cfie_config: CfieConfig) -> KVCacheSpec | None:
        mamba_block_size = cfie_config.cache_config.mamba_block_size
        page_size_padded = cfie_config.cache_config.mamba_page_size_padded
        return MambaSpec(
            ...
            mamba_cache_mode=cfie_config.cache_config.mamba_cache_mode,
