...
from cfie.distributed.communication_op import tensor_model_parallel_all_reduce
...
from cfie.model_executor.layers.lightning_attn import (
    lightning_attention,
    linear_decode_forward_triton,
)
from cfie.model_executor.layers.linear import ColumnParallelLinear, RowParallelLinear
...
from cfie.v1.attention.backends.linear_attn import LinearAttentionMetadata
...
class MiniMaxText01LinearAttention(nn.Module, MambaBase):
    ...
    def forward(
        ...
        torch.ops.cfie.linear_attention(
            hidden_states,
            output,
            positions,
            self.prefix,
