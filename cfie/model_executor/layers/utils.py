...
def apply_penalties(
    ...
    from cfie._custom_ops import apply_repetition_penalties
...
def rocm_unquantized_gemm_impl(
    ...
    from cfie.platforms.rocm import on_gfx9, on_gfx950
...
def rocm_unquantized_gemm(
    ...
    return torch.ops.cfie.rocm_unquantized_gemm(x, weight, bias)
