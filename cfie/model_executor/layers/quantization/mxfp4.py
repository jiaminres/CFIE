...
from cfie.model_executor.layers.fused_moe.gpt_oss_triton_kernels_moe import (
    OAITritonExperts,
    UnfusedOAITritonExperts,
)
from cfie.model_executor.layers.fused_moe.trtllm_moe import TrtLlmGenExperts
...
from cfie.model_executor.layers.quantization.utils.mxfp4_utils import (
    CK_MXFP4_MOE_DIM_ALIGNMENT,
    _can_support_mxfp4,
    _swizzle_mxfp4,
    get_padding_alignment,
)
from cfie.model_executor.layers.quantization.utils.quant_utils import is_layer_skipped
...
def get_mxfp4_backend_with_lora() -> Mxfp4Backend:
    ...
    triton_kernels_supported = (
        ...
        # SM110 fails with this error: https://github.com/cfie-project/cfie/issues/29317
    ...
    if current_platform.is_cuda():
        if (
            ...
            logger.warning_once(
                ...
                "Please `pip install cfie[flashinfer]` for best results."
            )
...
class Mxfp4MoEMethod(FusedMoEMethodBase):
    ...
    def __init__(self, moe: FusedMoEConfig):
        ...
        self.max_capture_size = (
            get_current_cfie_config().compilation_config.max_cudagraph_capture_size
        )
    ...
    def process_weights_after_loading(self, layer):
        if self.mxfp4_backend == Mxfp4Backend.MARLIN:
            ...
            from cfie.model_executor.layers.fused_moe.flashinfer_cutlass_moe import (
                FlashInferExperts,
            )
    ...
    def apply_monolithic(
        ...
        if (
            ...
            from cfie.model_executor.layers.fused_moe.gpt_oss_triton_kernels_moe import (  # noqa: E501
...
class XpuMxfp4MoEMethod(Mxfp4MoEMethod):
    ...
    def apply_monolithic(
        ...
        from cfie_xpu_kernels.fused_moe_interface import xpu_fused_moe
