...
from cfie.distributed import get_tensor_model_parallel_world_size
from cfie.logger import init_logger
from cfie.model_executor.layers.fused_moe import (
    FusedMoE,
...
from cfie.model_executor.layers.fused_moe.cpu_fused_moe import select_experts
from cfie.model_executor.layers.fused_moe.fused_marlin_moe import (
    BatchedMarlinExperts,
    MarlinExperts,
    fused_marlin_moe,
)
from cfie.model_executor.layers.fused_moe.oracle.fp8 import (
    convert_to_fp8_moe_kernel_format,
    make_fp8_moe_kernel,
    make_fp8_moe_quant_config,
    select_fp8_moe_backend,
)
from cfie.model_executor.layers.fused_moe.oracle.nvfp4 import (
    NvFp4MoeBackend,
...
from cfie.model_executor.layers.quantization.compressed_tensors.schemes.compressed_tensors_wNa16 import (  # noqa
    WNA16_SUPPORTED_BITS,
    WNA16_SUPPORTED_TYPES_MAP,
)
from cfie.model_executor.layers.quantization.utils.flashinfer_mxint4_moe import (
...
from cfie.model_executor.layers.quantization.utils.marlin_utils_fp4 import (
...
class CompressedTensorsW8A8Fp8MoEMethod(CompressedTensorsMoEMethod):
    ...
    def __init__(
        ...
        weight_key = ct2cfie_weight[self.weight_quant.strategy]
        if weight_key == kFp8Static128BlockSym:
            activation_key = kFp8Dynamic128Sym
        else:
            activation_key = ct2cfie_act[self.input_quant.strategy]
    ...
    def apply(
        ...
        return self.moe_kernel.apply(
            ...
            # https://github.com/cfie-project/cfie/commit/84166fee9770e6fba71a96978b3e7d149392fb28 # noqa: E501
            expert_map=layer.expert_map,
            apply_router_weight_on_input=layer.apply_router_weight_on_input,
            shared_experts_input=shared_experts_input,
        )
...
class CompressedTensorsW8A8Int8MoEMethod(CompressedTensorsMoEMethod):
    ...
    def apply(
        ...
        from cfie.model_executor.layers.fused_moe import fused_experts
...
class CompressedTensorsWNA16MoEMethod(CompressedTensorsMoEMethod):
    ...
    def select_gemm_impl(
        ...
        if self.moe.is_lora_enabled:
            ...
            if HAS_TRITON:
                from cfie.model_executor.layers.fused_moe import TritonWNA16Experts
...
class CompressedTensorsW4A8Fp8MoEMethod(CompressedTensorsMoEMethod):
    ...
    def select_gemm_impl(
        ...
        from cfie.model_executor.layers.fused_moe import CutlassExpertsW4A8Fp8
