...
from cfie.model_executor.layers.quantization.compressed_tensors.compressed_tensors_moe import (  # noqa: E501
    CompressedTensorsMoEMethod,
)
from cfie.model_executor.layers.quantization.compressed_tensors.schemes import (
...
from cfie.model_executor.layers.quantization.compressed_tensors.transform.linear import (  # noqa: E501
    CompressedTensorsLinearTransformMethod,
    get_linear_transform_schemes,
)
from cfie.model_executor.layers.quantization.compressed_tensors.utils import (
    find_matched_target,
...
class CompressedTensorsConfig(QuantizationConfig):
    ...
    def apply_cfie_mapper(self, hf_to_cfie_mapper: "WeightsMapper"):
        ...
        def _map_target(target: str) -> str | None:
            ...
            if is_layer_path:
                return hf_to_cfie_mapper._map_name(target)
            return target
