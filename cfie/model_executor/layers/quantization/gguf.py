...
class GGUFConfig(QuantizationConfig):
    ...
    def apply_cfie_mapper(self, hf_to_cfie_mapper: "WeightsMapper"):
        ...
        if self.unquantized_modules is not None:
            self.unquantized_modules = hf_to_cfie_mapper.apply_list(
...
try:
    ...
    fused_mul_mat_gguf = torch.ops.cfie._fused_mul_mat_gguf
...
def _fused_moe_gguf(
    ...
    from cfie.model_executor.layers.fused_moe.fused_moe import moe_align_block_size
...
try:
    ...
    fused_moe_gguf = torch.ops.cfie._fused_moe_gguf
...
try:
    ...
    apply_gguf_embedding = torch.ops.cfie._apply_gguf_embedding
