...
from cfie.distributed import get_tensor_model_parallel_rank, get_tp_group
...
class MoeWNA16Config(QuantizationConfig):
    ...
    def __init__(
        ...
        from cfie.model_executor.layers.quantization.awq import AWQConfig
        from cfie.model_executor.layers.quantization.awq_marlin import AWQMarlinConfig
        from cfie.model_executor.layers.quantization.gptq_marlin import GPTQMarlinConfig
