...
from cfie.model_executor.layers.quantization.utils.ocp_mx_utils import OCP_MX_BLOCK_SIZE
...
def quant_dequant_mxfp6(
    ...
    return torch.ops.cfie.quant_dequant_mxfp6(x, quant_dtype, scale_calculation_mode)
...
def dequant_mxfp6(
    ...
    return torch.ops.cfie.dequant_mxfp6(x, scale, float_dtype, quant_dtype)
