...
# https://github.com/cfie-project/cfie/issues/25270
...
#  https://github.com/cfie-project/cfie/issues/14397
class W8A8BlockFp8LinearOp:
    ...
    def _run_cutlass(
        ...
        if self.is_hopper:
            return torch.ops.cfie.padded_cutlass(
                q_input,
                weight,
                input_scale,
                weight_scale,
    ...
    def _run_triton(
        ...
        assert self.input_quant_op is not None
        q_input, input_scale = self.input_quant_op(input_2d)
        return torch.ops.cfie.w8a8_triton_block_scaled_mm_func(
            q_input,
            weight,
            input_scale,
            weight_scale,
    ...
    def _run_flashinfer(
        ...
        output = torch.ops.cfie.flashinfer_fp8_blockscale_gemm(
...
def requant_weight_ue8m0_inplace(
    ...
    from cfie.utils.deep_gemm import per_block_cast_to_fp8
...
def create_fp8_weight_parameter(
    ...
    from cfie.model_executor.parameter import ModelWeightParameter
...
def create_fp8_input_scale(
    ...
    from cfie.model_executor.parameter import PerTensorScaleParameter
