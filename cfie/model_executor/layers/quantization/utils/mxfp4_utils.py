...
from cfie.utils.torch_utils import direct_register_custom_op, is_torch_equal_or_newer
...
try:
    ...
    dequant_mxfp4 = torch.ops.cfie.dequant_mxfp4
...
try:
    ...
    quant_dequant_mxfp4 = torch.ops.cfie.quant_dequant_mxfp4
except AttributeError as error:
    raise error
