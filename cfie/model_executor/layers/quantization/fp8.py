...
from cfie.model_executor.layers.fused_moe.layer import UnquantizedFusedMoEMethod
...
from cfie.model_executor.layers.quantization.utils.marlin_utils_fp8 import (
...
from cfie.model_executor.model_loader.weight_utils import initialize_single_dummy_weight
...
class Fp8Config(QuantizationConfig):
    ...
    def apply_cfie_mapper(self, hf_to_cfie_mapper: "WeightsMapper"):
        if self.ignored_layers is not None:
            self.ignored_layers = hf_to_cfie_mapper.apply_list(self.ignored_layers)
        ...
        **extra_weight_attrs,
        ...
        def patched_weight_loader(param, loaded_weight, *args, **kwargs):
            ...
            if layer._loaded_numel == target_loaded_numel:
                ...
                # there is logic added to cfie in the future which calls a
