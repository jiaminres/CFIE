...
from cfie.platforms.interface import CpuArchEnum
...
class UnquantizedFusedMoEMethod(FusedMoEMethodBase, CustomOp):
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        if self.unquantized_backend == UnquantizedMoeBackend.FLASHINFER_TRTLLM:
            ...
            if current_platform.get_cpu_architecture() == CpuArchEnum.X86:
                from cfie.model_executor.layers.utils import check_cpu_sgl_kernel
    ...
    def forward_monolithic_cuda(
        ...
        import cfie.model_executor.layers.fused_moe.flashinfer_trtllm_moe  # noqa: F401

        assert self.unquantized_backend == UnquantizedMoeBackend.FLASHINFER_TRTLLM

        return torch.ops.cfie.flashinfer_fused_moe_bf16(
