...
def backend_to_kernel_cls(
    ...
    if backend == Fp8MoeBackend.FLASHINFER_TRTLLM:
        from cfie.model_executor.layers.fused_moe.experts.trtllm_fp8_moe import (  # noqa: E501
        ...
        from cfie.model_executor.layers.fused_moe.triton_cutlass_moe import (
