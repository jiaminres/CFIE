...
from cfie.model_executor.layers.quantization.utils.flashinfer_fp4_moe import (
...
fi_2_cfie_backend_map: dict[FlashinferMoeBackend, NvFp4MoeBackend] = {
...
def backend_to_kernel_cls(
    ...
    if backend == NvFp4MoeBackend.FLASHINFER_TRTLLM:
        from cfie.model_executor.layers.fused_moe.experts.trtllm_nvfp4_moe import (
        ...
        from cfie.model_executor.layers.fused_moe.flashinfer_cutedsl_moe import (
...
def select_nvfp4_moe_backend(
    ...
    if envs.is_set("VLLM_USE_FLASHINFER_MOE_FP4"):
        if not envs.VLLM_USE_FLASHINFER_MOE_FP4:
            ...
            backend = fi_2_cfie_backend_map[get_flashinfer_moe_backend()]
            return _return_or_raise(
