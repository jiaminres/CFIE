...
from cfie.model_executor.layers.fused_moe.flashinfer_trtllm_moe import (
...
def make_unquantized_moe_kernel(
    ...
    if backend == UnquantizedMoeBackend.FLASHINFER_CUTLASS:
        ...
        from cfie.model_executor.layers.fused_moe import TritonExperts
        ...
        from cfie.model_executor.layers.fused_moe import XPUExperts
