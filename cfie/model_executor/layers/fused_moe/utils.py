...
from cfie.model_executor.layers.quantization.utils.mxfp6_utils import (
    quant_dequant_mxfp6,
)
...
def _fp8_quantize(
    ...
    if block_shape is None:
        ...
        #  https://github.com/cfie-project/cfie/issues/20711
...
def _mxfp4_quantize(
    ...
    # TODO: native mxfp4 is currently not integrated in cfie,
...
def _mxfp6_e3m2_quantize(
    ...
    # TODO: native mxfp6 is currently not integrated in cfie,
    # so simulating even on devices supporting this data type natively.
...
# See https://github.com/cfie-project/cfie/issues/26378
@functools.cache
