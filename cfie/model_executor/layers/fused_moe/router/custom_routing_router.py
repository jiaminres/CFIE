...
class CustomRoutingRouter(BaseRouter):
    # 使用外部自定义 routing function 的 router 实现。
    ...
    def routing_method_type(self) -> RoutingMethodType:
        from cfie.model_executor.models.llama4 import Llama4MoE

        # Llama4 的自定义路由函数在 FLASHINFER_TRTLLM 路径下有专门支持。
    ...
    def _compute_routing(
        ...
        # 直接调用外部提供的 routing function 计算 top-k 权重与 expert id。
