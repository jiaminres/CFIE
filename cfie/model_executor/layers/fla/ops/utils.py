...
WARN_ON_FORMAT_MISMATCH = os.getenv("CFIE_FLA_WARN_ON_FORMAT_MISMATCH", "0") == "1"


def should_warn_on_format_mismatch(seq_len: int, num_heads: int) -> bool:
    return WARN_ON_FORMAT_MISMATCH and seq_len < num_heads
