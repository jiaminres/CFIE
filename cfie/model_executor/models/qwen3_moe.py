...
class Qwen3MoeSparseMoeBlock(nn.Module):
    def __init__(
        ...
        cfie_config = get_current_vllm_config()
...
class Qwen3MoeDecoderLayer(nn.Module):
    def __init__(self, cfie_config: VllmConfig, prefix: str = "") -> None:
        super().__init__()
        ...
        if (layer_idx not in mlp_only_layers) and (
            ...
            self.mlp = Qwen3MoeSparseMoeBlock(
                cfie_config=cfie_config, prefix=f"{prefix}.mlp"
            )
        else:
    ...
    def __init__(
        ...
        *,
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: decoder_layer_type(cfie_config=cfie_config, prefix=prefix),
...
class Qwen3MoeForCausalLM(
    ...
    def __init__(self, *, cfie_config: VllmConfig, prefix: str = ""):
        super().__init__()
        config = cfie_config.model_config.hf_text_config
        quant_config = cfie_config.quant_config
        self.config = config
