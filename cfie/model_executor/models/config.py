...
from cfie.model_executor.models import ModelRegistry
...
from cfie.v1.kv_cache_interface import FullAttentionSpec, MambaSpec, MLAAttentionSpec
...
class VerifyAndUpdateConfig:
    @staticmethod
    def verify_and_update_config(cfie_config: "CfieConfig") -> None:
        return
...
class DeepseekV32ForCausalLM(VerifyAndUpdateConfig):
    @classmethod
    def verify_and_update_config(cls, cfie_config: "CfieConfig") -> None:
        hf_config = cfie_config.model_config.hf_config

        # Mirror the check in cfie/model_executor/models/deepseek_v2.py
...
class Ernie4_5_VLMoeForConditionalGenerationConfig(VerifyAndUpdateConfig):
    ...
    def verify_and_update_config(cfie_config: "CfieConfig") -> None:
        ...
        cfie_config.compilation_config.fast_moe_cold_start = False
...
class GptOssForCausalLMConfig(VerifyAndUpdateConfig):
    @staticmethod
    def verify_and_update_config(cfie_config: "CfieConfig") -> None:
        structured_outputs_config = cfie_config.structured_outputs_config
...
class HybridAttentionMambaModelConfig(VerifyAndUpdateConfig):
    ...
    def verify_and_update_config(cls, cfie_config: "CfieConfig") -> None:
        ...
        mamba_block_size = cfie_config.cache_config.mamba_block_size
        # Enable FULL_AND_PIECEWISE by default
        MambaModelConfig.verify_and_update_config(cfie_config)
        ...
        mamba_page_size = MambaSpec(
            shapes=model_cls.get_mamba_state_shape_from_config(cfie_config),
            dtypes=model_cls.get_mamba_state_dtype_from_config(cfie_config),
...
class LlamaBidirectionalConfig(VerifyAndUpdateConfig):
    @staticmethod
    def verify_and_update_model_config(model_config: "ModelConfig") -> None:
        from cfie.config.pooler import SequencePoolingType
...
class MambaModelConfig(VerifyAndUpdateConfig):
    ...
    def verify_and_update_config(cls, cfie_config: "CfieConfig") -> None:
        ...
        if cache_config.enable_prefix_caching:
            ...
            if cache_config.mamba_cache_mode == "align":
                assert cfie_config.scheduler_config.enable_chunked_prefill, (
...
class NomicBertModelConfig(VerifyAndUpdateConfig):
    ...
    def verify_and_update_model_config(model_config: "ModelConfig") -> None:
        ...
        # The context extension uses cfie style rope_theta and rope_parameters.
        # See #17785 #18755
        if (
            ...
            if model_config.max_model_len != max_model_len_before:
                logger.warning(
                    ...
                    "https://github.com/cfie-project/cfie/tree/main/examples/offline_inference/context_extension.py",
...
class Qwen3ForSequenceClassificationConfig(VerifyAndUpdateConfig):
    ...
    def verify_and_update_model_config(model_config: "ModelConfig") -> None:
        ...
        assert tokens is not None and len(tokens) == 2, (
            ...
            "https://github.com/cfie-project/cfie/tree/main/examples/pooling/score/qwen3_reranker_offline.py"
        )
