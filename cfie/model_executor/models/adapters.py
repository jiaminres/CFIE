...
from cfie.model_executor.layers.activation import get_act_fn
from cfie.model_executor.models.config import VerifyAndUpdateConfig
from cfie.transformers_utils.config import (
    try_get_dense_modules,
)
from cfie.transformers_utils.repo_utils import get_hf_file_bytes

from .interfaces import supports_multimodal
from .interfaces_base import CfieModelForPooling, is_pooling_model
...
def _create_pooling_model_cls(orig_cls: _T) -> _T:
    ...
    class ModelForPooling(orig_cls, CfieModelForPooling):
        ...
        def __init__(
            ...
            **kwargs: Any,
            ...
            with no_init_weights(
                ...
                super().__init__(cfie_config=cfie_config, prefix=prefix, **kwargs)
            ...
            if not pooler:
                pooler = self._init_pooler(cfie_config, prefix=prefix)
...
def as_embedding_model(cls: _T) -> _T:
    ...
    # Lazy import
    from cfie.model_executor.layers.pooler import DispatchPooler
    ...
    class ModelForEmbedding(_create_pooling_model_cls(cls)):
        def _init_pooler(
            ...
            pooler_config = cfie_config.model_config.pooler_config
...
def as_seq_cls_model(cls: _T) -> _T:
    ...
    from cfie.model_executor.layers.pooler import DispatchPooler
    from cfie.model_executor.models.interfaces import SupportsCrossEncoding
...
def load_weights_using_from_2_way_softmax(
    ...
    model_config = model.cfie_config.model_config
    ...
    from cfie.tokenizers import get_tokenizer
    ...
    if hf_to_cfie_mapper := getattr(model, "hf_to_cfie_mapper", None):
        lm_head_name = hf_to_cfie_mapper._map_name(lm_head_name)
...
def seq_cls_model_loader(model, weights: Iterable[tuple[str, torch.Tensor]]):
    ...
    hf_config = model.cfie_config.model_config.hf_config
    text_config = hf_config.get_text_config()
    method = getattr(hf_config, "method", getattr(text_config, "method", None))
    assert method in SEQ_CLS_LOAD_METHODS, f"method {method} not supported"
