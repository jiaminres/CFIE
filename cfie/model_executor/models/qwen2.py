...
from cfie.transformers_utils.config import is_interleaved, set_default_rope_theta
...
class Qwen2Model(nn.Module, EagleModelMixin):
    def __init__(
        ...
        *,
        ...
        config = cfie_config.model_config.hf_config.get_text_config()
        cache_config = cfie_config.cache_config
        quant_config = cfie_config.quant_config

        # TODO (@robertgshaw2): see if this can be moved out
        if is_interleaved(cfie_config.model_config.hf_text_config):
