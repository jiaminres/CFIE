...
from cfie.config.multimodal import BaseDummyOptions
from cfie.distributed import divide, get_tensor_model_parallel_world_size
from cfie.model_executor.layers.activation import get_act_and_mul_fn
from cfie.model_executor.layers.conv import Conv2dLayer
...
from cfie.multimodal import MULTIMODAL_REGISTRY, MultiModalKwargsItems
from cfie.multimodal.inputs import (
    MultiModalDataDict,
    MultiModalFieldConfig,
    NestedTensors,
)
from cfie.multimodal.parse import (
    ImageProcessorItems,
    ImageSize,
    MultiModalDataItems,
)
from cfie.multimodal.processing import BaseDummyInputsBuilder
from cfie.multimodal.processing.processor import (
...
from cfie.transformers_utils.processors.pixtral import MistralCommonPixtralProcessor
...
from .utils import StageMissingLayer, init_cfie_registered_model, maybe_prefix
from .vision import (
    VisionEncoderInfo,
...
class PixtralForConditionalGeneration(
    ...
    def __init__(self, *, cfie_config: CfieConfig, prefix: str = ""):
        ...
        with self._mark_tower_model(cfie_config, "image"):
...
class PixtralHFVisionModel(nn.Module):
    ...
    #        ref: https://github.com/cfie-project/cfie/pull/7186#discussion_r1734163986
