...
class Qwen3ASRForConditionalGeneration(
    ...
    def __init__(self, *, cfie_config: VllmConfig, prefix: str = ""):
        super().__init__()
        self.cfie_config = cfie_config  # needed for torch compile forward context
        thinker_config: Qwen3ASRThinkerConfig = (
            cfie_config.model_config.hf_config.thinker_config
        )
        ...
        with self._mark_tower_model(cfie_config, "audio"):
        ...
        with self._mark_language_model(cfie_config):
            self.language_model = Qwen3ForCausalLM(
                cfie_config=cfie_config.with_hf_config(
