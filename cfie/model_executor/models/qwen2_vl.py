...
from cfie.distributed import parallel_state, tensor_model_parallel_all_gather
from cfie.distributed import utils as dist_utils
from cfie.logger import init_logger
from cfie.model_executor.layers.activation import QuickGELU
...
class Qwen2VLForConditionalGeneration(
    ...
    def __init__(self, *, cfie_config: CfieConfig, prefix: str = ""):
        super().__init__()
        config: Qwen2VLConfig = cfie_config.model_config.hf_config
