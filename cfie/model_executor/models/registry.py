...
from cfie.logging_utils import logtime
from cfie.tasks import ScoreType
from cfie.transformers_utils.dynamic_module import try_get_class_from_dynamic_module
...
_SUBPROCESS_COMMAND = [sys.executable, "-m", "cfie.model_executor.models.registry"]
...
class _LazyRegisteredModel(_BaseRegisteredModel):
    ...
    def _save_modelinfo_to_cache(self, mi: _ModelInfo, module_hash: str) -> None:
        ...
        from cfie.model_executor.model_loader.weight_utils import atomic_writer
...
ModelRegistry = _ModelRegistry(
    {
        model_arch: _LazyRegisteredModel(
            module_name=f"cfie.model_executor.models.{mod_relname}",
            class_name=cls_name,
        )
