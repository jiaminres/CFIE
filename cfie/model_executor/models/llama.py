...
class LlamaDecoderLayer(nn.Module):
    def __init__(
        ...
        # (e.g. parasail-ai/GritLM-7B-cfie)
    ...
    def get_quant_config(self, cfie_config: CfieConfig) -> QuantizationConfig | None:
        ...
        return cfie_config.quant_config
    ...
    def __init__(
        ...
        *,
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: layer_type(cfie_config=cfie_config, prefix=prefix),
    ...
    def forward(
        ...
        **extra_layer_kwargs,
        ...
        if not get_pp_group().is_last_rank:
            ...
            # PP 非最后 stage 命中 aux 层时，先把本 stage 的辅助 hidden states
            # 交给 model runner 本地消费，主干中间张量仍按原有 PP 字典继续传递。
...
class LlamaForCausalLM(
    ...
    def _init_model(
        ...
        return LlamaModel(cfie_config=cfie_config, prefix=prefix, layer_type=layer_type)
