...
from cfie.model_executor.layers.attention import (
    Attention,
...
class Llama4Model(LlamaModel):
    def __init__(
        ...
        *,
        ...
        self.num_experts = cfie_config.model_config.hf_config.num_local_experts
        self.n_redundant_experts = (
            cfie_config.parallel_config.eplb_config.num_redundant_experts
        )
        super().__init__(cfie_config=cfie_config, prefix=prefix, layer_type=layer_type)
        ...
        for param_name, weight_name, expert_id, shard_id in expert_params_mapping:
            ...
            if fused:
                ...
                if expert_map is not None:
                    ...
                    # https://github.com/cfie-project/cfie/issues/32862
...
class Llama4ForCausalLM(LlamaForCausalLM, MixtureOfExperts):
    ...
    def __init__(self, *, cfie_config: CfieConfig, prefix: str = ""):
        ...
        gen_config = cfie_config.model_config.try_get_generation_config()
        gen_config.update(cfie_config.model_config.override_generation_config)
        # enable temperature tuning by default when max_model_len > 32K
        default_attn_temperature_tuning = cfie_config.model_config.max_model_len > 32768
        cfie_config.model_config.hf_config.attn_temperature_tuning = gen_config.get(
            "attn_temperature_tuning", default_attn_temperature_tuning
        )

        super().__init__(
            cfie_config=cfie_config, prefix=prefix, layer_type=Llama4DecoderLayer
        )
    ...
    def _init_model(
        ...
        return Llama4Model(
            cfie_config=cfie_config, prefix=prefix, layer_type=layer_type
        )
