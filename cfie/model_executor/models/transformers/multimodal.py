...
from cfie.model_executor.models.interfaces import SupportsMRoPE, SupportsMultiModal
from cfie.multimodal import MultiModalKwargsItems
...
class MultiModalMixin(SupportsMultiModal, SupportsMRoPE):
    ...
    def __init__(self, *, cfie_config: "CfieConfig", prefix: str = ""):
        ...
        super(SupportsMRoPE, self).__init__(cfie_config=cfie_config, prefix=prefix)
    ...
    def get_language_model(self) -> torch.nn.Module:
        ...
        # Keep only classes defined in `cfie.model_executor.models.transformers`
