...
from cfie.model_executor.models.utils import maybe_prefix
...
class TransformersFusedMoE(FusedMoE):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        return torch.ops.cfie.transformers_moe_forward(
            hidden_states,
...
class MoEMixin(MixtureOfExperts):
    def __init__(self, *, cfie_config: "CfieConfig", prefix: str = ""):
        ...
        super(MixtureOfExperts, self).__init__(cfie_config=cfie_config, prefix=prefix)
