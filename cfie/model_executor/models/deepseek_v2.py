...
from cfie.config import CacheConfig, ParallelConfig, CfieConfig, get_current_cfie_config
...
from cfie.model_executor.layers.layernorm import LayerNorm, RMSNorm
...
from cfie.model_executor.layers.mla import MLAModules, MultiHeadLatentAttentionWrapper
...
from cfie.model_executor.layers.sparse_attn_indexer import SparseAttnIndexer
...
from cfie.v1.attention.backends.mla.indexer import (
    DeepseekV32IndexerBackend,
)
from cfie.v1.kv_cache_interface import KVCacheSpec, MLAAttentionSpec
...
class Indexer(nn.Module):
    def __init__(
        ...
        self.prefix = prefix
        from cfie.v1.attention.backends.mla.indexer import get_max_prefill_buffer_size

        self.max_total_seq_len = get_max_prefill_buffer_size(cfie_config)
...
class DeepSeekV2FusedQkvAProjLinear(MergedColumnParallelLinear):
    ...
    def forward(
        ...
        if self._use_min_latency_gemm:
            output = torch.ops.cfie.min_latency_fused_qkv_a_proj(input_, self.weight)
    ...
    def __init__(self, *, cfie_config: CfieConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: DeepseekV2DecoderLayer(
                cfie_config, prefix, topk_indices_buffer=topk_indices_buffer
            ),
