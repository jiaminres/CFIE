...
from cfie.model_executor.layers.linear import QKVParallelLinear, RowParallelLinear
...
from cfie.transformers_utils.config import set_default_rope_theta
...
class Qwen3Model(Qwen2Model):
    def __init__(self, *, cfie_config: CfieConfig, prefix: str = ""):
        super().__init__(
            cfie_config=cfie_config, prefix=prefix, decoder_layer_type=Qwen3DecoderLayer
        )
