...
from cfie.config import CompilationMode, get_current_cfie_config
...
class TorchFP8ScaledMMLinearKernel(FP8ScaledMMLinearKernel):
    ...
    def get_output_padding(self) -> int | None:
        ...
        # https://github.com/cfie-project/cfie/issues/32269
        cfie_config = get_current_cfie_config().compilation_config
        pad_output = cfie_config.mode < CompilationMode.VLLM_COMPILE
