...
from cfie.lora.utils import is_moe_model
...
from cfie.model_executor.model_loader.utils import ParamMapping
...
from cfie.model_executor.models import is_pooling_model
from cfie.model_executor.utils import (
...
class BitsAndBytesModelLoader(BaseModelLoader):
    ...
    def __init__(self, load_config: LoadConfig):
        ...
        # mapping weight names from transformers to cfie.
    ...
    def _hf_weight_iter(self, hf_weights_files, use_safetensors: bool):
        ...
        for org_name, param in iterator:
            # mapping weight names from transformers to cfie while preserving
            # original names.
        ...
        for name, module in model.named_modules():
            if isinstance(module, LinearBase) and hasattr(
                ...
                if modules_info := self.modules_mapping.get_sub_modules(name):
                    # Map cfie's names to transformers's names.
    ...
    def _initialize_loader_state(
        ...
        # For some models like Molmo, we need to use hf_to_cfie_mapper
        # to ensure correct loading of weights.
        if hf_to_cfie_mapper := getattr(model, "hf_to_cfie_mapper", None):
            self.weight_mapper = lambda name: hf_to_cfie_mapper._map_name(name)
    ...
    def _stack_quantization_states(
        ...
        from cfie.model_executor.models.utils import is_pp_missing_parameter
