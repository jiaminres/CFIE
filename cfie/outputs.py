...
from cfie.logprobs import PromptLogprobs, SampleLogprobs
from cfie.lora.request import LoRARequest
from cfie.v1.metrics.stats import RequestStateStats
...
class CompletionOutput:
    ...
    router_logits: np.ndarray | None = None  # [seq_len,layer_num,num_experts]
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"router_logits={self.router_logits}, "
