...
from cfie.exceptions import LoRAAdapterNotFoundError
from cfie.logger import init_logger
from cfie.lora.lora_model import LoRAModel
from cfie.lora.model_manager import (
    LoRAModelManager,
    LRUCacheLoRAModelManager,
    create_lora_manager,
)
from cfie.lora.peft_helper import PEFTHelper
...
class WorkerLoRAManager:
    ...
    def __init__(
        ...
        self.vocab_size = cfie_config.model_config.get_vocab_size()
        self.lora_config = cfie_config.lora_config

        # Use get_text_config() in case of multimodal models
        text_config = cfie_config.model_config.hf_config.get_text_config()
        ...
        if cfie_config.model_config.is_encoder_decoder:
