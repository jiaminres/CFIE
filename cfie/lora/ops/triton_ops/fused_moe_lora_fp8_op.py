...
try:
    ...
    fused_moe_lora_fp8 = torch.ops.cfie.fused_moe_lora_fp8
    fused_moe_lora_shrink_fp8 = torch.ops.cfie.fused_moe_lora_shrink_fp8
    fused_moe_lora_expand_fp8 = torch.ops.cfie.fused_moe_lora_expand_fp8
