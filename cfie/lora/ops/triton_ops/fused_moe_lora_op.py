...
try:
    ...
    fused_moe_lora = torch.ops.cfie.fused_moe_lora
    fused_moe_lora_shrink = torch.ops.cfie.fused_moe_lora_shrink
    fused_moe_lora_expand = torch.ops.cfie.fused_moe_lora_expand
