...
from cfie.entrypoints.ssl import SSLCertRefresher
from cfie.logger import init_logger
from cfie.utils.network_utils import find_process_using_port
...
async def serve_http(
    ...
    **uvicorn_kwargs: Any,
    ...
    # Windows 上 add_signal_handler 可能直接抛 NotImplementedError
    try:
