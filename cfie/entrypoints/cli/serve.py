...
from cfie.entrypoints.cli.types import CLISubcommand
...
from cfie.entrypoints.utils import VLLM_SUBCMD_PARSER_EPILOG
...
from cfie.v1.engine.utils import CoreEngineProcManager, launch_core_engines
from cfie.v1.executor import Executor
from cfie.v1.executor.multiproc_executor import MultiprocExecutor
from cfie.v1.metrics.prometheus import setup_multiprocess_prometheus
from cfie.v1.utils import APIServerProcessManager, wait_for_completion_or_failure
...
class ServeSubcommand(CLISubcommand):
    ...
    def cmd(args: argparse.Namespace) -> None:
        ...
        if getattr(args, "grpc", False):
            from cfie.entrypoints.grpc_server import serve_grpc
...
def run_headless(args: argparse.Namespace):
    ...
    engine_args = cfie.AsyncEngineArgs.from_cli_args(args)
...
def run_multi_api_server(args: argparse.Namespace):
    ...
    from cfie.v1.engine.utils import get_engine_zmq_addresses
