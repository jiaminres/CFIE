...
from cfie.entrypoints.launcher import terminate_if_errored
from cfie.entrypoints.openai.engine.protocol import ErrorInfo, ErrorResponse
from cfie.entrypoints.utils import create_error_response, sanitize_message
from cfie.exceptions import VLLMValidationError
from cfie.logger import init_logger
from cfie.utils.gc_utils import freeze_gc_heap
from cfie.v1.engine.exceptions import EngineDeadError, EngineGenerateError

logger = init_logger("cfie.entrypoints.openai.server_utils")
...
def get_uvicorn_log_config(args: Namespace) -> dict | None:
    ...
    if args.disable_access_log_for_endpoints:
        from cfie.logging_utils import create_uvicorn_log_config
