...
from cfie.engine.arg_utils import AsyncEngineArgs, optional_type
from cfie.entrypoints.chat_utils import (
    ChatTemplateContentFormatOption,
    validate_chat_template,
)
from cfie.entrypoints.constants import (
    H11_MAX_HEADER_COUNT_DEFAULT,
    H11_MAX_INCOMPLETE_EVENT_SIZE_DEFAULT,
)
from cfie.entrypoints.openai.models.protocol import LoRAModulePath
...
class BaseFrontendArgs:
    ...
    * "openai" will render the content as a list of dictionaries, similar to
    ...
    def add_cli_args(cls, parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        """
        from cfie.engine.arg_utils import get_kwargs
