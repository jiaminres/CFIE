...
from cfie.entrypoints.openai.engine.serving import OpenAIServing, SpeechToTextRequest
...
from cfie.inputs import EncoderDecoderInputs, ProcessorInputs
from cfie.logger import init_logger
from cfie.logprobs import FlatLogprobs, Logprob
from cfie.model_executor.models import SupportsTranscription
from cfie.multimodal.audio import split_audio
from cfie.multimodal.media.audio import extract_audio_from_video_bytes
from cfie.outputs import RequestOutput
from cfie.renderers.inputs import DictPrompt, EncoderDecoderDictPrompt
from cfie.renderers.inputs.preprocess import parse_enc_dec_prompt, parse_model_prompt
...
class OpenAISpeechToText(OpenAIServing):
    ...
    def model_cls(self) -> type[SupportsTranscription]:
        from cfie.model_executor.model_loader import get_model_cls
