...
from cfie.entrypoints.pooling.embed.protocol import (
    EmbeddingRequest,
    EmbeddingResponse,
)
...
from cfie.entrypoints.utils import create_error_response
...
async def main(args: Namespace):
    from cfie.entrypoints.openai.api_server import build_async_engine_client
