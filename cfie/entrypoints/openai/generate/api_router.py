...
def register_generate_api_routers(app: FastAPI):
    ...
    from cfie.entrypoints.openai.responses.api_router import (
    ...
    from cfie.entrypoints.anthropic.api_router import (
...
async def init_generate_state(
    ...
    from cfie.entrypoints.anthropic.serving import AnthropicServingMessages
    from cfie.entrypoints.chat_utils import load_chat_template
    from cfie.entrypoints.mcp.tool_server import (
        DemoToolServer,
        MCPToolServer,
        ToolServer,
    )
    from cfie.entrypoints.openai.chat_completion.serving import OpenAIServingChat
    from cfie.entrypoints.openai.completion.serving import OpenAIServingCompletion
    from cfie.entrypoints.openai.responses.serving import OpenAIServingResponses
    from cfie.entrypoints.serve.disagg.serving import ServingTokens
