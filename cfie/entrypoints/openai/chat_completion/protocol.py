...
from cfie.sampling_params import (
    BeamSearchParams,
...
class ChatCompletionRequest(OpenAIBaseModel):
    ...
    cfie_xargs: dict[str, str | int | float | list[str | int | float]] | None = Field(
        default=None,
        description=(
    ...
    def to_sampling_params(
        ...
        extra_args: dict[str, Any] = self.cfie_xargs if self.cfie_xargs else {}
