...
from cfie.entrypoints.pooling.io_processor_factories import init_pooling_io_processors
from cfie.entrypoints.pooling.score.utils import (
    ScoreData,
...
from cfie.entrypoints.utils import log_non_default_args
...
from cfie.renderers import ChatParams, merge_kwargs
from cfie.renderers.inputs.preprocess import (
    conversation_to_seq,
    parse_model_prompt,
    prompt_to_seq,
)
from cfie.sampling_params import BeamSearchParams, RequestOutputKind, SamplingParams
from cfie.tasks import PoolingTask
from cfie.tokenizers import TokenizerLike
from cfie.usage.usage_lib import UsageContext
from cfie.utils.counter import Counter
from cfie.utils.mistral import is_mistral_tokenizer
from cfie.utils.tqdm_utils import maybe_tqdm
from cfie.v1.engine import PauseMode
from cfie.v1.engine.llm_engine import LLMEngine
from cfie.v1.sample.logits_processor import LogitsProcessor

if TYPE_CHECKING:
    from cfie.v1.metrics.reader import Metric
...
class LLM:
    ...
    def _late_interaction_score(
        ...
        *,
        ...
        """
        from cfie.outputs import PoolingOutput
