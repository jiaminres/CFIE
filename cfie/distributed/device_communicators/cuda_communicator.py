...
from cfie.distributed.device_communicators.all_reduce_utils import (
    should_nccl_symm_mem_allreduce,
)
from cfie.distributed.device_communicators.pynccl import register_nccl_symmetric_ops
from cfie.distributed.device_communicators.pynccl_allocator import (
...
class CudaCommunicator(DeviceCommunicatorBase):
    def __init__(
        ...
        if "tp" not in unique_name:
            ...
            from cfie.distributed.parallel_state import _ENABLE_CUSTOM_ALL_REDUCE
        ...
        from cfie.distributed.device_communicators.custom_all_reduce import (
            CustomAllreduce,
        )
        from cfie.distributed.device_communicators.flashinfer_all_reduce import (
            FlashInferAllReduce,
        )
        from cfie.distributed.device_communicators.pynccl import PyNcclCommunicator
        from cfie.distributed.device_communicators.quick_all_reduce import (
            QuickAllReduce,
        )
        from cfie.distributed.device_communicators.symm_mem import SymmMemCommunicator
    ...
    def all_reduce(self, input_):
        ...
        if self.pynccl_comm is not None and should_nccl_symm_mem_allreduce(
            ...
            out = torch.ops.cfie.all_reduce_symmetric_with_copy(input_)
            if out is not None:
                return out
