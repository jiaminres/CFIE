...
from cfie.distributed import get_dp_group, get_ep_group
from cfie.forward_context import get_forward_context
from cfie.logger import init_logger
from cfie.utils.flashinfer import has_flashinfer_all2all
from cfie.utils.import_utils import has_deep_ep, has_mori
...
class DeepEPAll2AllManagerBase(All2AllManagerBase):
    ...
    def __init__(self, cpu_group, tcp_store_group=None):
        assert has_deep_ep(), (
            "DeepEP kernels not found. Please follow https://github.com/cfie-project/cfie/blob/main/tools/ep_kernels/README.md"
...
class FlashInferAllToAllManager(All2AllManagerBase):
    ...
    # https://github.com/cfie-project/cfie/issues/26533 done.
    rank: int
    world_size: int
    ...
    def initialize(
        ...
        from cfie.distributed.device_communicators.mnnvl_compat import (
            CustomCommunicator,
        )
...
class MoriAll2AllManager(All2AllManagerBase):
    ...
    def _make_all2all_kwargs(
        ...
        from cfie.platforms.rocm import on_gfx942, on_gfx950
