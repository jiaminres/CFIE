...
from cfie.distributed.device_communicators.cuda_wrapper import CudaRTLibrary
...
def can_actually_p2p(
    ...
    See https://github.com/cfie-project/cfie/issues/2728 and
...
#  e.g. used by different cfie engines. The device id in the cache file is a
#  **local** device id, i.e. from 0 to num_dev-1, where num_dev is the number
#  of visible devices in the cfie engine.
