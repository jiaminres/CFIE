...
from cfie.distributed.weight_transfer.base import WeightTransferEngine
...
WeightTransferEngineFactory.register_engine(
    "nccl",
    "cfie.distributed.weight_transfer.nccl_engine",
    "NCCLWeightTransferEngine",
)

WeightTransferEngineFactory.register_engine(
    "ipc",
    "cfie.distributed.weight_transfer.ipc_engine",
