...
from cfie.v1.attention.backend import AttentionBackend, AttentionMetadata
...
if TYPE_CHECKING:
    ...
    from cfie.distributed.kv_events import KVCacheEvent, KVConnectorKVEvents
    ...
    from cfie.forward_context import ForwardContext
    from cfie.v1.core.kv_cache_manager import KVCacheBlocks
...
class KVConnectorBase_V1(ABC):
    ...
    def __init__(
        ...
        self._cfie_config = cfie_config
        if cfie_config.kv_transfer_config is not None:
            self._kv_transfer_config = cfie_config.kv_transfer_config
        else:
    ...
    @classmethod
    def get_required_kvcache_layout(cls, cfie_config: "CfieConfig") -> str | None:
        """
        Get the required KV cache layout for this connector.
        Args:
            cfie_config (CfieConfig): the cfie config.
