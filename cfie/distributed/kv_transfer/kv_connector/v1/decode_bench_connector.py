...
Usage:
    ...
    Example:
        cfie serve <model> --kv-transfer-config '{
    ...
    Then run your benchmark with desired input/output lengths:
        cfie bench serve --base-url http://127.0.0.1:8000 --model <model> \\
...
class DecodeBenchConnector(KVConnectorBase_V1):
    ...
    def __init__(
        ...
        super().__init__(cfie_config, role, kv_cache_config)
        ...
        if role == KVConnectorRole.SCHEDULER:
            self.connector_scheduler = DecodeBenchConnectorScheduler(cfie_config)
        elif role == KVConnectorRole.WORKER:
            self.connector_worker = DecodeBenchConnectorWorker(cfie_config)
...
class DecodeBenchConnectorScheduler:
    ...
    def __init__(self, cfie_config: "CfieConfig"):
        ...
        self.block_size = cfie_config.cache_config.block_size
...
class DecodeBenchConnectorWorker:
    ...
    def __init__(self, cfie_config: "CfieConfig"):
        ...
        kv_transfer_config = cfie_config.kv_transfer_config
