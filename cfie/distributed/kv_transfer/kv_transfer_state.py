...
from cfie.distributed.kv_transfer.kv_connector.base import KVConnectorBaseType
...
def ensure_kv_transfer_initialized(
    cfie_config: "CfieConfig", kv_cache_config: "KVCacheConfig | None" = None
) -> None:
    """
    ...
    if cfie_config.kv_transfer_config is None:
        return

    if (
        cfie_config.kv_transfer_config.is_kv_transfer_instance
