...
class FlexibleArgumentParser(ArgumentParser):
    ...
    def parse_args(  # type: ignore[override]
        ...
        if args and args[0] == "serve":
            ...
            try:
                ...
                logger.warning(
                    "With `cfie serve`, you should provide the model as a "
                ...
                # [Before]
                # cfie serve -tp 2 --model <model> --enforce-eager --port 8001
                # [After]
                # cfie serve <model> -tp 2 --enforce-eager --port 8001
                args = [
                    "serve",
                    model_tag,
                    *args[1:model_idx],
            ...
            if (
                ...
                raise ValueError(
                    ...
                    "using `cfie serve`. i.e. `cfie serve <model> --<arg> <value>`."
                )
    ...
    def _pull_args_from_config(self, args: list[str]) -> list[str]:
        ...
        ```
        ```python
        $: cfie {serve,chat,complete} "facebook/opt-12B" \
