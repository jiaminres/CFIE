...
def force_use_trtllm_attention() -> bool | None:
    """
    This function should only be called during initialization stage when cfie config
    is set.
    ...
    return cfie_config.attention_config.use_trtllm_attention
...
if has_flashinfer():
    ...
    @torch.library.custom_op(
        "cfie::flashinfer_nvfp4_quantize",
        mutates_args=[],
        device_types="cuda",
    )
