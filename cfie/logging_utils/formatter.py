...
class NewLineFormatter(logging.Formatter):
    ...
    def format(self, record):
        def shrink_path(relpath: Path) -> str:
            ...
            - Removes leading 'cfie' folder if present.
            ...
            - Examples:
            cfie/model_executor/layers/quantization/utils/fp8_utils.py ->
            model_executor/.../quantization/utils/fp8_utils.py
            cfie/model_executor/layers/quantization/awq.py ->
