...
if TYPE_CHECKING:
    from cfie.v1.worker.kv_connector_model_runner_mixin import KVConnectorOutput
else:
...
class IntermediateTensors:
    ...
    def __eq__(self, other: object):
        ...
        return all(
            ...
            if isinstance(self.tensors[k], torch.Tensor)
            and isinstance(other.tensors[k], torch.Tensor)
            else self.tensors[k] == other.tensors[k]
