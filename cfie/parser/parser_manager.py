...
from cfie.utils.import_utils import import_from_path

if TYPE_CHECKING:
    from cfie.parser.abstract_parser import Parser
...
class ParserManager:
    ...
    def register_module(
        ...
        """Register a Parser class. Can be used as decorator or called directly."""
    ...
    def get_parser(
        ...
        from cfie.parser.abstract_parser import _WrappedParser

        if not tool_parser_name and not reasoning_parser_name:
            return None

        # Strategy 1: If both names match, check for a unified parser
        ...
        # Strategy 3: Create a DelegatingParser
