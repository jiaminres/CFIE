...
def maybe_serialize_tool_calls(request: "MistralChatCompletionRequest"):
    # SEE: https://github.com/cfie-project/cfie/pull/9951
...
class MistralTokenizer(TokenizerLike):
    IS_MISTRAL_TOKENIZER = True  # used by cfie.utils.mistral
    ...
    def convert_ids_to_tokens(
        ...
        if any("�" in t for t in tokens) and self.is_tekken:
            ...
            # See: https://github.com/cfie-project/cfie/pull/8640
            #      https://github.com/cfie-project/cfie/pull/9625
