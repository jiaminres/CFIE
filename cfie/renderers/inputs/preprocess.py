...
if TYPE_CHECKING:
    ...
    from cfie.entrypoints.chat_utils import ChatCompletionMessageParam
...
"""
A [`DecoderOnlyPrompt`][cfie.inputs.data.DecoderOnlyPrompt]
...
"""
A [`EncoderPrompt`][cfie.inputs.data.EncoderPrompt]
that has been standardized into a dictionary.
"""
...
"""
A [`DecoderPrompt`][cfie.inputs.data.DecoderPrompt]
that has been standardized into a dictionary.
"""
...
class EncoderDecoderDictPrompt(TypedDict):
    """
    A [`EncoderDecoderPrompt`][cfie.inputs.data.EncoderDecoderPrompt]
    that has been standardized into a dictionary.
    """
...
"""
A [`SingletonPrompt`][cfie.inputs.data.SingletonPrompt]
that has been standardized into a dictionary.
"""
...
"""
A [`PromptType`][cfie.inputs.data.PromptType]
that has been standardized into a dictionary.
"""
